...
module network {
  ...
  source             = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/network?ref=feature/external_secrets"
...
module cognito {
  source       = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/cognito/user-pool?ref=feature/external_secrets"
...
module cognito_users {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/cognito/users?ref=feature/external_secrets"
...
// Create RDS instance
module "rds" {
  source  = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/rds?ref=feature/external_secrets"
...
// Create S3 bucket
module "s3" {
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/storage/s3?ref=feature/external_secrets"
  module_depends_on = []
...
// ArgoCD
module argocd {
  source                    = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/cicd/argo-cd?ref=feature/external_secrets"
...
module profiles {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/kubeflow-profiles?ref=feature/external_secrets"
  argocd = module.argocd.state
...
module kube2iam {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/kube2iam?ref=feature/external_secrets"
  argocd = module.argocd.state
...
module kfserving {
  source = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/kfserving/0-3-0/?ref=feature/external_secrets"
  argocd = module.argocd.state
}
...
module cluster_autoscaler {
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/cluster-autoscaler?ref=feature/external_secrets"
  image_tag         = "v1.15.7"
  cluster_name      = module.kubernetes.cluster_name
  module_depends_on = [module.kubernetes]
  argocd            = module.argocd.state
...
module cert_manager {
  module_depends_on = [module.kubernetes]
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/cert-manager?ref=feature/external_secrets"
  cluster_name      = module.kubernetes.cluster_name
  domains           = [var.domain]
  vpc_id            = local.vpc_id
  environment       = var.environment
...
module alb_ingress {
  module_depends_on = [module.kubernetes]
  source            = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/ingress/aws-alb?ref=feature/external_secrets"
  cluster_name      = module.kubernetes.cluster_name
  domains           = [var.domain]
  vpc_id            = local.vpc_id
...
module external_dns {
  source       = "git::https://github.com/at-gmbh/swiss-army-kube.git//modules/system/external-dns?ref=feature/external_secrets"
  cluster_name = module.kubernetes.cluster_name
  vpc_id       = local.vpc_id
